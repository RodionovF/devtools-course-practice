...
float HypothecCalculator::return_final_amount_of_payment()
{
    ...
    if (differentiated_payment_type)
    {
        ...
        {
            accrued_interest_in_the_period = loan_debt * interest_rate_in_month / (12 * 100);
            debt_per_month_extra = debt_per_month_main + accrued_interest_in_the_period;
...
date HypothecCalculator::return_final_date_of_payment()
{
    ...
    final_date_of_payment.month = (start_of_payments.month + credit_term_in_month) % 12 - 1;
    final_date_of_payment.year = (start_of_payments.year + (credit_term_in_month + start_of_payments.month) / 12);
